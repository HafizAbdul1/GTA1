...
<div class="main-content">
    ...
    <tr>
        ...
        <td>Pending</td>
        <td> 
            <a href="{{ route('adminsection.view-apprentice') }}" class="btn btn-view">View</a>
            <a href="{{ route('adminsection.add-apprentice') }}" class="btn btn-edit">Edit</a>
        </td>
    </tr>
    <tr>
        <td>Jane Smith</td>
