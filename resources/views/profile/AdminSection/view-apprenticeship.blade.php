...
<head>
    ...
    @vite(['resources/css/edit-apprenticeship.css']) 
...
<nav id="sidebar">
    <ul>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <div>
            <li class="active"><a href="{{ route('adminsection.view-apprenticeship') }}">View Apprenticeships</a></li>
  ...
  <div class="main-content">
    <header>
        <h1>View Apprenticeships</h1>
    </header>

    <table border="1">
        <thead>
            <tr>
                <th>Apprenticeship Name</th>
                <th>Duration</th>
                <th>Components</th>
                <th>Actions</th>
            </tr>
        ...
        <tbody>
            @foreach($apprenticeships as $apprenticeship)
                <tr>
                    <td>{{ $apprenticeship->apprenticeship_name }}</td>
